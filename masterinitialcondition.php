...
function checkchangecategory(element)
    ...
    function deleterow(element) {
        ...
        var myid = splitid[1];
        Swal.fire({
            title: 'Do you want to delete this initial condition?',
            html: 'You cannot recover this initial condition after delete',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: {
                        tipe: "initial_condition",
                        idinitialcondition: myid
                        ...
                        if (status == "ok") {
                            ...
                            Swal.fire({
                                ...
                                html: 'There is <b>' + jumlah +
                                    "</b> Initial Condition is active on list of Asset, please delete it first",
                                confirmButtonText: 'Ok',
                                confirmButtonColor: '#32d419',
                            });
                        }
