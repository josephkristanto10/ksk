...
<div class="content-wrapper">
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <h4><span class="font-weight-semibold">Asset's Lend to Other Department </span></h4>
            ...
            <div class="modal-body">
                <form id="myforms">
                    <div class="form-group">
                        <label for="cars" style="font-size:11pt;"><b>Department Section</b></label><br>
            ...
            <div class="modal-body">
                <form id="myforms">
                    ...
                    <label for="cars" style="font-size:11pt;"><b>Department Section</b></label><br>
                        ...
                        <label for="cars" style="font-size:11pt;"><b>Room Section</b></label><br>
                        <label for="cars">Branch :</label>
                        <select id="branchedit" name="branchroom" class="form-control">
                            <?php
                                        for($i = 0 ; $i < count($mybranch); $i++)
                                        {                                            
                                                echo '<option value="'.$mybranch[$i]['idbranch'].'">'.$mybranch[$i]['branch'].'</option>';                                       
...
<script>
    ...
    function adddata() {
        ...
        if (arridselectedassetadd.length > 0) {
            if (startdate == "" || enddate == "" || department == null|| room == null) {
            Swal.fire({
                icon: 'error',
                title: 'Empty Field',
...
$('#selectassetedit').on('shown.bs.modal', function () {
    ...
    function openmodaledits(element) {
        ...
        var iddepartments_ =  $("#iddepartment_" + myid).val();
        ...
        $('#departmentedit option[value=' + iddepartments_ + ']').prop('selected', true);
    ...
    function asseteditshow() {
        ...
        $.ajax({
            ...
            method: 'POST',
            data: {
                tipe: "getassettransactionlendotherdepartment",
    ...
    function editdata() {
        ...
        var enddate = $('#enddateedit').val();
            if (startdate == "" || enddate == "" || room == null)  {
                Swal.fire({
                    icon: 'error',
                    title: 'Empty Field',
                    text: 'Requirement data cannot be empty',
