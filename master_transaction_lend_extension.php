...
<div class="content-wrapper">
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <h4><span class="font-weight-semibold">Asset's Lend Extension </span></h4>
    ...
    <div class="content">
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                <h5><span class="font-weight-semibold" >Extension Transaction Type :  </span></h5>
